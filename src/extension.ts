...
export function activate(context: vscode.ExtensionContext) {
  context.subscriptions.push(
    vscode.commands.registerCommand('pomsky.openPreview', () => {
...
class PomskyPreviewPanel {
  public static currentPanel: PomskyPreviewPanel | undefined

  public static readonly viewType = 'pomsky.preview'
