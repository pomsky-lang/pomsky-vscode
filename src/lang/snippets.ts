...
type CompletionItemBlueprint = CompletionItem | { range: never }
...
export const globalSnippets: CompletionItemBlueprint[] = detailedCompletions([
  {
    label: 'Start',
    detail: 'built-in',
    documentation: new MarkdownString('Start of the string. Equivalent to `^`.'),
    kind: CompletionItemKind.Value,
  },
  {
    label: 'End',
    detail: 'built-in',
    documentation: new MarkdownString('End of the string. Equivalent to `$`.'),
    kind: CompletionItemKind.Value,
  },
  {
    label: 'Codepoint',
    detail: 'built-in',
    documentation: new MarkdownString('A single code point.'),
    kind: CompletionItemKind.Value,
  },
  {
    label: 'C',
  ...
  },
  {
    label: 'Grapheme',
    detail: 'built-in',
    documentation: new MarkdownString('A single grapheme cluster.'),
    kind: CompletionItemKind.Value,
  },
  {
    label: 'G',
  ...
  {
    label: 'range',
    insertText: new SnippetString("range '${1:0}'-'${2:255}'"),
    detail: 'snippet',
    documentation:
      new MarkdownString(`Matches a range of numbers. Use this if the number may be more than 1 code point.
...
~~~`),
  ...
  },
  {
    ...
    detail: 'snippet',
    documentation: new MarkdownString(`Makes lazy matching the default.`),
    kind: CompletionItemKind.Snippet,
  },
  {
    label: 'disable',
    ...
    detail: 'snippet',
    documentation: new MarkdownString(`Makes greedy matching the default.
...
Note that greedy matching is usually the default, unless \`enable lazy;\` was used.`),
  ...
  {
    label: 'let',
    insertText: new SnippetString('let ${1:var_name} = $0;\n'),
    detail: 'snippet',
    documentation: new MarkdownString(`Declares a variable.
...
~~~`),
  ...
  // TODO: only show after repetition
  {
    ...
    detail: 'keyword',
    documentation:
      new MarkdownString(`Keyword to make the previous repetition lazy. Opposite of \`greedy\`.
...
~~~`),
  ...
  },
  {
    ...
    detail: 'keyword',
    documentation:
      new MarkdownString(`Keyword to make the previous repetition greedy. Opposite of \`lazy\`.
...
~~~`),
  ...
  // TODO: only show after range
  {
    ...
    detail: 'keyword',
    documentation:
      new MarkdownString(`Comes after a \`range\` expression to set the number base, e.g. 16 for hexadecimal.
...
export const charSetSnippets: CompletionItemBlueprint[] = [
  ...prepareChars([
...
function detailedCompletions(snippets: Snippet[]): CompletionItem[] {
  return snippets.map(({ label, insertText, documentation, detail, kind }) => ({
...
function unicodeCompletions(name: string, items: string[]): CompletionItemBlueprint[] {
    ...
    return [
      {
        ...
        insertText: first,
        detail: name,
        documentation: new MarkdownString(`The \`${first}\` ${name}`),
      ...
      ...rest.map(label => ({
        ...
        insertText: label,
        detail: name,
        documentation: new MarkdownString(`Alias for the \`${first}\` ${name}`),
        kind: CompletionItemKind.Constant,
      })),
    ]
  })
...
function prepareChars(items: [string, string][]): CompletionItemBlueprint[] {
  return items.map(
...
function prepareCharClasses(items: [string, string][]): CompletionItemBlueprint[] {
  return items.map(
    ([label, documentation]): CompletionItem => ({
      label,
      insertText: label,
